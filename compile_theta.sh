...
CC  -O3 rwx.o parallel_qoz_theta.c -o parallel_qoz -I $qozsrc -L $qozlib -I $zstdsrc -L $zstdlib -l zstd -lm 
...
CC -O3 rwx.o parallel_mgard_theta.c -o parallel_mgard  -I $mgardsrc  -I $metasrc -L $metalib -lsz_cpp -I $zstdsrc -L $zstdlib  -l zstd  -lm
